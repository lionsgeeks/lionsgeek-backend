...
@switch($name)
    ...
    @case('press')
        <svg height="20px" width="20px" fill="currentColor" version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg"
    ...
    @case('connect')
        <svg xmlns="http://www.w3.org/2000/svg" class="size-5" fill="currentColor" class="bi bi-person-workspace"
            viewBox="0 0 16 16">
    ...
    @case('sp')
        <svg xmlns="http://www.w3.org/2000/svg" class="size-5" fill="currentColor" class="bi bi-person-video3"
            viewBox="0 0 16 16">
    ...
    @default
        <!-- Default icon here if no name matches -->
@endswitch
