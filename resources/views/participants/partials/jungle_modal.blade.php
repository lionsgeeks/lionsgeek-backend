<div class="flex items-center justify-center">
    <div x-data="{ jungleModal: false }">
        <!-- Button to open the modal -->
        <button @click="jungleModal = true" class="w-full bg-black px-2 py-1 rounded font-medium text-white ">
            Jungle </button>
        <!-- Background overlay -->
        <div x-show="jungleModal" class="fixed inset-0 transition-opacity" aria-hidden="true" @click="jungleModal = false">
            <div class="absolute inset-0 bg-gray-500 opacity-75"></div>
        </div>
        <!-- Modal -->
        <div x-show="jungleModal" x-transition:enter="transition ease-out duration-300 transform"
                        ...
                        <div class="">
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                <div class="mt-2">
                                    ...
                                    <form action="{{ route('participant.jungle') }}" method="POST"
                                        ...
                                        <div class="px-4 py-3 sm:px-6 gap-3 sm:flex sm:flex-row-reverse">
                                            <button type="submit"
                                                ...
                                                Send </button>
                                            <button @click="jungleModal = false" type="button"
