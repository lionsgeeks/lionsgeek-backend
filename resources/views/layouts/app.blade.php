                ...
                <header class="shadow flex  justify-between items-center w-full transition-all duration-300"
                    ...
                    <div class="px-5 pt-2" x-data="{ showNotif: false }">
                        ...
                        @if ($notifications->count() > 0)
                            <div
                                class="w-4 h-4 bg-red-500 text-white flex justify-center items-center rounded-lg absolute top-4 right-[7.3rem]">
                    ...
                    <button x-on:dblclick='darkmode = !darkmode' class="mr-4 cursor-default">
