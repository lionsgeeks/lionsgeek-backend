<x-app-layout>
    ...
    <div class="flex gap-3 flex-wrap font-medium p-5 w-full">
                ...
                <div class="bg-white  p-5 flex flex-col gap-4 border rounded-lg">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <h1>second session :
                                {{ \Carbon\Carbon::parse($infosession->end_date)->format('d/m/Y') }}
                            </h1>
                        </div>
                        <div class="flex items-center gap-3">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                            ...
                            <h1>Time :
                                {{ \Carbon\Carbon::parse($infosession->end_date)->format('h:i A') }}
                            </h1>
                        </div>
                    </div>
