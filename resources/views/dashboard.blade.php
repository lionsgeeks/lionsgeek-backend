<x-app-layout>
    ...
    <div class="py-12 ">
        <div class="max-w-7xl mx-auto   sm:px-6 lg:px-8">
            <div class=" w-full   overflow-hidden p-4 flex flex-col gap-y-8 ">

                <div class="flex items-center justify-between">
                    <h1 class="text-md font-medium capitalize text-gray-500">hello {{ Auth::user()->name }},</h1>
                    <div>
                        <button
                            class="px-6 py-2 bg-black text-white text-base font-medium rounded-md shadow hover:bg-gray-700  transition">
                            Add Admin
                        </button>
                        <button
                            class="px-6 py-2 bg-black text-white text-base font-medium rounded-md shadow hover:bg-gray-700  transition">
                ...
                <div class="w-full grid grid-cols-4 gap-x-4">
                    <div class=" px-4 py-4  shadow-md bg-white  text-black flex   items-center justify-around rounded-md  ">
                        <span class="w-[50px] h-[50px] rounded-full border-black border bg-white relative">
                    ...
                    <div class=" px-4 py-4  shadow-md bg-white flex  items-center gap-x-2 rounded-md  ">
                        <span class="w-[50px] h-[50px] rounded-full border border-black bg-white relative">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="black"
                    ...
                    <div class=" px-4 py-4  shadow-md bg-white flex  items-center gap-x-2 rounded-md  ">
                        <span class="w-[50px] h-[50px] rounded-full  border border-black relative">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="black"
                                class="bi bi-envelope text-black absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]"
                                viewBox="0 0 16 16">
                                <path
                ...
                @if ($sessions)
                    <div class="  p-4 shadow-md rounded-md flex flex-col gap-y-4 bg-white ">
                        <h1 class="text-3xl font-bold ">Upcoming Info Sessions</h1>
                            ...
                            @foreach ($sessions as $session)
                                <div class="flex items-center gap-x-2 ">
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <h2 class="text-sm font-medium text-[#919391]">{{ $session->name }}</h2>
                                    </div>
            ...
            <div class="w-ful grid grid-cols-2 gap-x-4">
                <div class=" h-[40vh] shadow-md rounded-md bg-white">
                        ...
                        matchesFilter(participant) {
                            ...
                            <div class="p-6 text-gray-900 ">
                                <div class="flex justify-between items-center">
                                    ...
                                    <a href="{{ route('coworkings.index') }}" class="underline text-alpha">See all</a>
                                </div>
                                <table class="w-full ">
                                                    ...
                                                    <div class=" flex justify-center">
                                                        <template x-if="!cow.status">
                                                            ...
                                                            <form method="POST"
                                                                ...
                                                                @csrf
                                                                @method('PUT')
                                                                <button class="border p-1 rounded-md" type="submit"
                    ...
                    @else
                        <div class=" bg-white  h-full rounded-md flex items-center justify-center w-full">
                ...
                <div class="h-[40vh]  bg-white shadow-md  rounded-md">
                        ...
                        <div class=" overflow-hidden  sm:rounded-lg">
                            ...
                            <div class="p-6 text-gray-900 ">
                                <div class="flex justify-between items-center">
                                    ...
                                    <a href="{{ route('events.index') }}" class="underline text-alpha">See all</a>
                                </div>
                                <table class="w-full ">
                                    <thead class="border-b">
                                        <th class=" ">Event</th>
            ...
            <div class="w-full  bg-white p-4 rounded-md flex flex-col gap-y-2 ">

                @if ($blogs)

                    <div class="flex justify-between items-center ">
                        <div class="flex items-center gap-x-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#003161" class="bi bi-card-text" viewBox="0 0 16 16">
                                <path d="M14.5 3a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-13a.5.5 0 0 1-.5-.5v-9a.5.5 0 0 1 .5-.5zm-13-1A1.5 1.5 0 0 0 0 3.5v9A1.5 1.5 0 0 0 1.5 14h13a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2z"/>
                                <path d="M3 5.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5M3 8a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9A.5.5 0 0 1 3 8m0 2.5a.5.5 0 0 1 .5-.5h6a.5.5 0 0 1 0 1h-6a.5.5 0 0 1-.5-.5"/>
                              </svg>

                            <h1 class="text-3xl font-bold">Latest Blogs</h1>
                        </div>
                    ...
                    <div class=" grid grid-cols-3 gap-x-4 ">
                        @foreach ($blogs as $blog)
                            <div class=" flex flex-col gap-y-2">
                                <div class="h-[20vh]">
                                    <img class="w-full aspect-video object-cover rounded-[16px] h-full"
                                        src="{{ asset('storage/images/' . $blog->image) }}" alt="">
                                </div>

                                <h1 class="text-xl font-light  w-fit  rounded-full">
                                    {{ $blog->title->en }}</h1>
