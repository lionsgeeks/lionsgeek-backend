    ...
    <div class="p-10">
        ...
        <div class="flex gap-4">
            ...
            <div class="bg-white flex flex-col  gap-5 font-bold  w-1/4 px-5 py-8 shadow rounded-xl">
                ...
                <p class="">Interview: {{ $infoSession->participants->where('current_step', 'interview')->count() }}</p>
                <p class="">Jungle: {{ $infoSession->participants->where('current_step', 'jungle')->count() }}</p>
                <p class="">School: {{ $infoSession->participants->where('current_step', "like", "%school%")->count() }}</p>
            </div>
