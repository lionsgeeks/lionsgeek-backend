<x-app-layout>
    ...
    <div class="pt-12">
        <div class="mx-auto sm:px-6 lg:px-8">
            @if ($blogs->count() > 0)
                <div class="bg-white min-h-[76vh] mb-3 shadow-sm sm:rounded-lg">
                                    ...
                                    @foreach ($blogs->reverse() as $blog)
                                        <tr class="w-full text-center">
                                            <td class="flex py-2 items-center justify-center">
                                                <img class="w-32 h-20 border shadow object-cover" src="{{ asset('storage/images/blog/' . $blog->image) }}" alt="">
                                            </td>
                                            <td>
                                                {{ $blog->title->en }}
                                            </td>
                                            ...
                                            <div class="bg-white rounded-lg shadow-lg p-6 w-[37vw] ">
                                                ...
                                                <p class="text-sm text-gray-600 mt-2">Do you really want to remove this blog? This
